...
<!-- parralex  -->
   <section class="h-96 bg-fixed bg-center bg-no-repeat bg-cover" style="background-image: url('./assets/images/graphics banners.png')">
...
<section class="xl:py-20 py-10 xl:px-20 lg:px-10 px-5">
    <div class="flex flex-col lg:flex-row xl:gap-20 gap-10">
        <div class="lg:w-2/3 w-full">
            <img src="./assets/images/graphic.jpg" class="rounded-2xl w-full" alt="">
        </div>
