	...
	<div class="row">
		<div class="col-md-4">
			...
			<ul class="nav nav-pills nav-stacked">
				<li class="active"><a href="#6a" data-toggle="tab">Classe 6 (Grade 1)</a></li>
				<li><a href="#6b" data-toggle="tab">Classe 6 (Grade 2)</a></li>
				<li><a href="#7a" data-toggle="tab">Classe 7 (Grade 1)</a></li>
				<li><a href="#7b" data-toggle="tab">Classe 7 (Grade 2)</a></li>
				<li><a href="#8a" data-toggle="tab">Classe 8 (Grade 1)</a></li>
				<li><a href="#8b" data-toggle="tab">Classe 8 (Grade 2)</a></li>
				<li><a href="#9a" data-toggle="tab">Classe 9 (Grade 1)</a></li>
				<li><a href="#9b" data-toggle="tab">Classe 9 (Grade 2)</a></li>
				<li><a href="#10a" data-toggle="tab">Classe 10 (Grade 1)</a></li>
				<li><a href="#10b" data-toggle="tab">Classe 10 (Grade 2)</a></li>
			</ul>
			</div>
		</div>
		<div class="col-md-8">
		<div class="tab-content clearfix" id="printTable">
			<div class="panel panel-info tab-pane active" id="6a">
				<div class="panel-heading">Classe 6 (Grade 1)</div>
			...
			<div class="panel panel-info tab-pane" id="6b">
				<div class="panel-heading">Class e 6 (Grade 2)</div>
			...
			<div class="panel panel-info tab-pane" id="7a">
				<div class="panel-heading">Class e 7 (Grade 1)</div>
			...
			<div class="panel panel-info tab-pane" id="7b">
				<div class="panel-heading">Class e 7 (Grade 2)</div>
				...
				<button onclick='printDiv("PrintClass7final")' class="btn btn-info pull-right">Print</button>
			</div> <!-- panel -->
			<div class="panel panel-info tab-pane" id="8a">
				<div class="panel-heading">Class e 8 (Grade 1)</div>
				...
				<button onclick='printDiv("PrintClass8")' class="btn btn-info pull-right">Print</button>
			</div> <!-- panel -->
			<div class="panel panel-info tab-pane" id="8b">
				<div class="panel-heading">Class e 8 (Grade 2)</div>
				...
				<button onclick='printDiv("PrintClass8final")' class="btn btn-info pull-right">Print</button>
			</div> <!-- panel -->
			<div class="panel panel-info tab-pane" id="9a">
				<div class="panel-heading">Class e 9 (Grade 1)</div>
				...
				<button onclick='printDiv("PrintClass9")' class="btn btn-info pull-right">Print</button>
			</div> <!-- panel -->
			<div class="panel panel-info tab-pane" id="9b">
				<div class="panel-heading">Class e 9 (Grade 2)</div>
				...
				<button onclick='printDiv("PrintClass9final")' class="btn btn-info pull-right">Print</button>
			</div> <!-- panel -->
			<div class="panel panel-info tab-pane" id="10a">
				<div class="panel-heading">Class e 10 (Grade 1)</div>
				...
				<button onclick='printDiv("PrintClass10")' class="btn btn-info pull-right">Print</button>
			</div> <!-- panel -->
			<div class="panel panel-info tab-pane" id="10b">
				<div class="panel-heading">Class e 10 (Grade 2)</div>
				...
				<button onclick='printDiv("PrintClass10final	")' class="btn btn-info pull-right">Print</button>
			</div> <!-- panel -->
		</div>
		</div>
	</div>
