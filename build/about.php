...
<!-- <?php require_once "includes/banner.php" ?>
	...
	<section class="h-96 bg-fixed bg-center bg-no-repeat bg-cover" style="background-image: url('./assets/images/about.png');">
...
<section class="xl:px-20 lg:px-10 px-5 xl:py-20 py-10 ">
    ...
    <div class="lg:w-1/2 w-full">
        <img src="./assets/images/aboutimg.avif" alt="">
    </div>
   </div>
...
<section class="xl:px-20 lg:px-10 px-5 xl:py-20 py-10 ">
    <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10">
        ...
        <div class="text-center bg-white p-6 rounded-lg shadow-md hover:bg-black transition duration-300 group hover:text-white">
            ...
            <h2 class="xl:text-3xl text-2xl pt-2">Vision</h2>
        ...
        <div class="text-center bg-white p-6 rounded-lg shadow-md hover:bg-black transition duration-300 group hover:text-white">
            ...
            <h2 class="xl:text-3xl text-2xl pt-2">Mission</h2>
