	...
	<nav class="navbar navbar-inverse" role="navigation">
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav side-nav">
				...
				<li><a href="my_classes.php"><i class="fa fa-book"></i> Classes</a></li>
				<li><a href="profile.php"><i class="fa fa-user"></i> Profile</a></li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-edit"></i> Results <b class="caret"></b></a>
					<ul class="dropdown-menu">
						<li><a href="add_result.php">Add Result</a></li>
						<li class="divider"></li>
						<li><a href="edit_result.php">View/Edit Results</a></li>
					</ul>
				</li>
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a href="update_attendance.php">View/Edit Attendance</a></li>
					</ul>
				</li>
			</ul>
			<ul class="nav navbar-nav navbar-right navbar-user">
				<li><a href="../index.php" target="_blank">Return to Website</a></li>
