...
<div class="panel-heading"><h3>View/Edit Attendance</h3></div>
<?php
	...
	<div class="row">
		<div class="col-md-12">
			<div class="alert alert-success alert-dismissible" role="alert">
			  ...
			  <strong>Attendance was successfully updated!</strong>
			</div>
		</div>
	</div>
</div>
			...
			<tbody>
				<?php
					...
					while ($row = mysqli_fetch_assoc($result)) {
						...
						echo "<td><a class='btn btn-info' href='update_attendance.php?global_name_id=$global_name_id'>View/Edit Attendance</a></td>";
