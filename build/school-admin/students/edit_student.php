...
<form action="" method="post">
	...
	<div class="col-md-3">
		<div class="form-group">
			...
			<select name="student_group" class="form-control" id="student-group">
				...
				<option value="Humanities" <?php echo $studentGrp == "Humanities"? "selected" : ""; ?>>Social/General</option>
				<option value="Commerce" <?php echo $studentGrp == "Commerce"? "selected" : ""; ?>>Business/Advertisement</option>
			</select>
		</div>
	</div>
	<div class="col-md-3">
	...
	<div class="col-md-12">
		<div class="form-group">
			<input type="submit" Value="Edit Data" class="btn btn-info" name="update_student_btn">
		</div>
	</div>
</form>
