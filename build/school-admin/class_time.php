				...
				<div class="col-md-6">
					...
					<form action="" method="post">
						<div class="form-group">
							<label for="">Edit the class schedule</label>
							<input type="text" name="class_time" class="form-control" value="<?php echo get_class_time_by_id($class_time_id); ?>">
						</div>
						<div class="form-group">
							<input type="submit" name="update_class_time_submit" value="Edit the schedule" class="btn btn-info">
						</div>
					</form>
					<?php } else { ?>
					<?php add_class_time(); ?>
					<form action="" method="post">
						...
						<div class="form-group">
							<input type="submit" name="class_time_submit" value="Add Schedule" class="btn btn-info">
						</div>
					</form>
					<?php } ?>
				</div>
