						...
						<tbody>
							<?php
								...
								while ($row = mysqli_fetch_assoc($result)) {
									...
									echo "<td><a href='sections.php?delete_section=".$row['id']."' class='btn btn-danger delete-hidden'>Delete</a><span class='text-danger shwo-text'>To delete, click the checkbox</span></td>";
									echo "</tr>";
								}
							?>
						</tbody>
